                ...
                <div class="content col-xs-12 col-sm-12 col-md-8 col-lg-7 offset-lg-1">
                    <div class="films">
                        ...
                        <ul class="media_list list-inline">
                            <?php $film = $bdd->query('SELECT * FROM video WHERE categorie = "film" ORDER BY date_publication DESC limit 0,8');
                            foreach ($film as $f) { ?>
                    ...
                    <div class="series ">
                        ...
                        <hr>
                        <ul class="media_list list-inline">
                            <?php $serie = $bdd->query('SELECT * FROM video WHERE categorie = "serie" ORDER BY date_publication DESC limit 0,8');
                            foreach ($serie as $s) { ?>
