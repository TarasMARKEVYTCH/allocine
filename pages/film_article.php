    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                $article = $bdd->prepare('SELECT * FROM video WHERE categorie = "film" AND id = ?');
                        ...
                        <form method="POST">
                            <div class="card_film">
                                ...
                                <div class="card_films-body">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=<?= $article['link'] ; ?>" target="blank" class="btn btn-info films_btn">Regarder teaser</a>
                                </div>
                                <?php
                                if (isset($_SESSION['id'])) { ?>
        ...
        <form method="Post">
            <textarea name="film_comment" class="comment" cols="50" rows="10" placeholder="Votre commentaire"></textarea><br>
            <input type="submit" class="comment_btn" name="film_comment_btn" value="Envoyer">
        </form>
